	...
	function formcraft3_file_upload()
	{
		...
		if ( isset($_FILES['files']) )
		{
			foreach ($_FILES as $key => $file) {
				...
				$allowed = array('png','doc','docx','xls','xlsx','csv','txt','rtf','html','zip','mp3','wma','wmv','mpg','flv','avi','jpg','jpeg','png','gif','ods','rar','ppt','pptx','tif','wav','mov','psd','eps','sit','sitx','cdr','ai','mp4','m4a','bmp','pps','aif', 'pdf', 'svg', 'odt','psa');
